...
/* function drawInitialGrid(){
  //in caso volessi mettere le cose a random
  if (riversRows.includes(rowIndex)) {
    cell.classList.add('river');
    if(Math.round(Math.random())) cell.classList.add('wood');
  }
...
function drawGrid() {
  ...
  gridMatrix.forEach(function (rowCells, rowIndex) { 
    ...
    rowCells.forEach(function (cellContent, cellIndex) {
      ...
      if (riversRows.includes(rowIndex)) cell.classList.add('river');
      else if (roadRows.includes(rowIndex)) cell.classList.add('road');
      else applyCellStyle(cell, rowIndex, cellIndex);
